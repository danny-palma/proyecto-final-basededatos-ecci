...
6. **Configurar App Check (Seguridad)**:
   - Ve a la sección "App Check" en Firebase Console
   ...
   - Para ReCaptcha v3:
     ...
     - Agrega tu dominio (localhost para desarrollo, tu-dominio.com para producción)
     - Copia la Site Key
   - En Firebase Console, configura ReCaptcha v3 como proveedor
   - Para desarrollo, puedes usar debug tokens

7. Obtén tu configuración de Firebase y crea el archivo `.env.local`:
...
VITE_FIREBASE_RECAPTCHA_V3_SITE_KEY=tu-recaptcha-site-key
```
